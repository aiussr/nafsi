...
export const MainContent = () => {
  return (
    <main className="ml-80 w-full">
      <div className="max-w-3xl mx-auto py-20 px-16">
        
        {/* Introduction - with sub-chapters */}
        <section id="intro-welcome" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a',
            borderLeftStyle: 'solid'
          }}>
            <h2 className="text-4xl font-light tracking-tight mb-4" style={{ color: '#1a1a1a' }}>
              Welcome
            </h2>
          ...
          <div className="space-y-6 text-base leading-relaxed font-light" style={{ color: '#333' }}>
            <p>
        ...
        <section id="intro-context" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        <section id="intro-framework" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        {/* Foundations */}
        <section id="foundations" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        {/* Practice */}
        <section id="practice" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        <section id="mastery-complexity" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        <section id="mastery-integration" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        <section id="synthesis-convergence" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
        ...
        <section id="synthesis-application" className="min-h-screen mb-32">
          <div className="border-l pl-8 mb-12" style={{ 
            borderLeftWidth: '2px', 
            borderLeftColor: '#1a1a1a'
          }}>
